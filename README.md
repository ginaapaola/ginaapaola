<div align="center">
  <h1>Hey there, I'm Gina Paola 👋</h1>
  <p>Systems Engineering Student · Colombia</p>
</div>
...
Systems Engineering student interested in **web development** and **data analytics**.  
Passionate about learning new technologies, improving my full stack development skills,  
and growing professionally by building useful and innovative technology solutions.

```python
gina = {
    "focus":    ["Full Stack Development", "Data Analytics"],
    "learning": ["NestJS", "FastAPI", "React", "Data Science"],
